    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="1.5"
          d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10a2 2 0 01-2 2h-2a2 2 0 01-2-2zm9-7h2a2 2 0 012 2v5a2 2 0 01-2 2h-2a2 2 0 01-2-2v-5a2 2 0 012-2z"
        />
      </svg>
    ),
  },
    ...
    <aside className="hidden md:flex flex-col h-screen w-64 fixed left-0 top-0 bg-charcoal-900 border-r border-charcoal-800 py-8 z-50">
      ...
      <div className="px-8 mb-10 flex items-center gap-2.5">
        ...
        <div
          ...
          onClick={() => navigate("/")}
        >
          <span className="font-display text-xs font-bold tracking-[0.25em] text-gold-400 leading-none">
            LUMIÈRE
          </span>
          <span className="text-[7px] font-sans text-charcoal-500 uppercase tracking-widest mt-1">
            Verified Seller
          </span>
        </div>
      </div>
