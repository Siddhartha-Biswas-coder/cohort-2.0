  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* View Details hover overlay button at the bottom */}
        <div 
          className="absolute inset-x-0 bottom-0 bg-charcoal-950/85 backdrop-blur-xs border-t border-charcoal-800/60 py-2.5 text-center transition-all duration-300 transform translate-y-full group-hover/image:translate-y-0 opacity-0 group-hover/image:opacity-100 z-20 cursor-pointer hover:bg-gold-400 hover:text-charcoal-950 hover:border-gold-400"
          onClick={() => navigate(`/product/${product.productId}`)}
        >
          <span className="font-display text-[9px] font-bold uppercase tracking-[0.25em] text-gold-400 group-hover/image:text-gold-100 hover:text-charcoal-950 transition-colors duration-200">
            View Details
          </span>
        </div>
      </ImageCarousel>
