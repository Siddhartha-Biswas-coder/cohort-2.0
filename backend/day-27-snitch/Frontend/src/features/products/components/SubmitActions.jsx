    ...
    <div className="flex flex-col gap-4 select-none">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-end gap-4">
        ...
        <button
          ...
          onClick={onPublish}
          disabled={isSubmitting}
          className="w-full sm:w-auto px-10 py-3.5 bg-gold-400 hover:bg-gold-500 text-charcoal-950 font-display text-[10px] font-bold uppercase tracking-[0.2em] shadow-gold-glow hover:shadow-gold-glow-strong hover:scale-[1.015] active:scale-[0.99] transition-all duration-300 focus:outline-none focus:ring-1 focus:ring-gold-600 disabled:opacity-50 disabled:pointer-events-none cursor-pointer relative"
        >
          {isSubmitting ? (
            <span className="flex items-center justify-center gap-2">
              <svg className="animate-spin h-3 w-3 text-charcoal-950" fill="none" viewBox="0 0 24 24">
