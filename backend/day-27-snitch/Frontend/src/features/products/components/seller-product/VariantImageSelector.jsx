              ...
              {img ? (
                <>
                  ...
                  <button
                    ...
                    className="absolute inset-0 bg-charcoal-950/80 opacity-0 group-hover/vslot:opacity-100 transition-opacity duration-200 flex items-center justify-center text-red-400 cursor-pointer"
                  >
